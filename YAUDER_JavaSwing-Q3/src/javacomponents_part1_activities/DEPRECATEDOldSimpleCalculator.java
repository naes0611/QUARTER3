...
public class DEPRECATEDOldSimpleCalculator extends javax.swing.JFrame {
     ...
     */
    public DEPRECATEDOldSimpleCalculator() {
        initComponents();
    }
...
//        } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DEPRECATEDOldSimpleCalculator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DEPRECATEDOldSimpleCalculator().setVisible(true);
            }
        });
    }
