...
public class DEPRECATEDOldSimpleCalculatorV2 extends javax.swing.JFrame {
     ...
     */
    public DEPRECATEDOldSimpleCalculatorV2() {
        initComponents();
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DEPRECATEDOldSimpleCalculatorV2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DEPRECATEDOldSimpleCalculatorV2().setVisible(true);
            }
        });
    }
